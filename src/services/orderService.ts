import { orderModel, deliveryAgentModel, brandModel, categoryModel, returnPolicyModel, warrantyPolicyModel, activityLogModel } from "../models";
import {
  Types,
  Document,
  QueryOptions,
...
export const getOrderActivityLogByAdmin = async (orderProductId: Types.ObjectId) => {
  return await activityLogModel.aggregate([
    {
      $match: { referenceId: orderProductId }
    },
    { $sort: { createdAt: 1 } }, 
    {
      $facet: {
