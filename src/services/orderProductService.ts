...
export const getVendorOrderProductById = async (_id: Types.ObjectId): Promise<any> => {
...
export const getVendorShippingProducts = async (options: IVendorShippingProductsOptions): Promise<IOrderProducts> => {
...
export const getVendorReturnProducts = async (options: IVendorReturnProductsOptions): Promise<IOrderProducts> => {
...
export const getVendorRefundProducts = async (options: IVendorRefundProductsOptions): Promise<IOrderProducts> => {
