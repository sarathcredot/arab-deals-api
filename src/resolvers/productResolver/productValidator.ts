...
export const productsQueryValidator = [
    ...
    body('variables.input.color').optional({ checkFalsy: true }).isArray({ min: 0 }),
...
export const createProductValidator = [
    ...
    body('variables.input.color').optional({ checkFalsy: true }),
    body('variables.input.size').optional({ checkFalsy: true }),
