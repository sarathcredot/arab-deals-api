    ...
    Query: {
        ...
        getActiveChildCategoriesInMobile: async (parent, { input }, { req }, info) => {
            try {
                ...
                const result = await categoryService.findCategoriesWithFilters({ path: mPath, isBlocked: false, isDefault: false }, { _id: 1, categoryName: 1, isLeaf: 1, categoryImage: 1 }, { lean: true, sort: { categoryName: 1 } });
